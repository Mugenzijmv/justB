                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                        <div class="my-1 text-center">
                                <h5 class="dark">New Associations</h5>
                               
                            <div class="card-content">
                                <ul class="list-inline clearfix pt-1 mb-0">
                                    <li class="border-right-grey border-right-lighten-2 pr-2">
                                        <h2 class="grey darken-1 text-bold-400" style="color: #ffa200;">5</h2>
                                        <span class="primary"></span>
                                            This Week</span>
                                    </li>
                                    <li class="pl-2">
                                        <h2 class="grey darken-1 text-bold-400" style="color: #ffa200;">35</h2>
                                        <span class="danger"></span>
                                            This Month</span>
                                    </li>
                                </ul><br>
                                <div class="card-header mb-2 pt-0">
                                    <button class="btn btn-dark btn-block btn-square" style="background-color: #444;">View ALL</button>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                        <div class="my-1 text-center">
                                <h4 class="">New Memberships</h4>
                               
                            <div class="card-content">
                                <ul class="list-inline clearfix pt-1 mb-0">
                                    <li class="border-right-grey border-right-lighten-2 pr-2">
                                        <h2 class="grey darken-1 text-bold-400" style="color: #ffa200;">10</h2>
                                        <span class="primary" ></span>
                                            This Week</span>
                                    </li>
                                    <li class="pl-2">
                                        <h2 class="grey darken-1 text-bold-400" style="color: #ffa200;">3</h2>
                                        <span class="danger"></span>
                                            This Month</span>
                                    </li>
                                </ul><br>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                        <div class="my-1 text-center">
                            <div class="card-header mb-2 pt-0">
                                <h4 class="secondary">All associations</h4>
                                <h3 class="font-large-2 text-bold-200" style="color: #ffa200;">120 <span class="font-medium-1 grey darken-1 text-bold-400">Associations</span></h3>
                            </div>
                            <div class="card-header mb-2 pt-0">
                                <button class="btn btn-dark btn-block btn-square" style="background-color: #444;">View ALL</button>
                            </div>
