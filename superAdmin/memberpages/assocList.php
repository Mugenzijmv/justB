		...
		<div class="card">
			<div class="card-head">
				<div class="card-header">
					<h4 class="card-title">All Associations (10)</h4>
				</div>
			</div>
			<div class="card-content">
              ...
              <tr>
                <th style="width: 2px;">2</th>
                  ...
                  <a href="assocMemberships">
                    <p class="mb-25 latest-update-item-name text-bold-600">Jau Solutions <i class="fa fa-question-circle" style="color: red; font-size: 20px;"></i></p>
                  </a>
								</td>
								<td class="">
              ...
              <tr>
                <th style="width: 2px;">1</th>
								<td>
                  <a href="assocMemberships">
                    <p class="mb-25 latest-update-item-name text-bold-600">Rwanda Graphic Designers</p>
                  </a>
								</td>
								<td class="">
									<a class="email" href="mailto:email@example.com">eugene@example.com</a>
