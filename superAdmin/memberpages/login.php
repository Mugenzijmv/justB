...
<!-- Mirrored from pixinvent.com/stack-responsive-bootstrap-4-admin-template/html/ltr/horizontal-menu-template/login-with-bg-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2020 15:35:04 GMT -->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../assets/superAdmin/app-assets/css/pages/login-register.min.css">
    <!-- END: Page CSS-->
  ...
  <body class="horizontal-layout horizontal-menu horizontal-menu-padding 1-column blank-page blank-page" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="index" novalidate>
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control" id="user-name" placeholder="Enter Email"
                                    required>
                            ...
                            <a href="index" type="submit" class="btn btn-outline-primary btn-block">
    ...
    <script src="../../../assets/superAdmin/app-assets/js/scripts/forms/form-login-register.min.js"></script>
    <!-- END: Page JS-->
