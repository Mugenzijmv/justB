      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color: #444">
        <a class="navbar-brand brand-logo" href="../../index.html"><img src="../../../../../assets/superAdmin/assets/images/logo/logo(SVG).svg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="../../../../../assets/superAdmin/assets/images/logo/logo-mini(SVG).svg" alt="logo"/></a>                    
      </div>

      <div class="navbar-menu-wrapper d-flex flex-grow" style="background-color: #444;">
        ...
        <ul class="navbar-nav navbar-nav-left collapse navbar-collapse" id="horizontal-top-example">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="projects-dropdown">
              <a class="dropdown-item" href="AssocList">
          ...
          <li class="nav-item nav-profile">
            <a href="" class="nav-link">
              ...
              <div class="nav-profile-img">
                <img src="../profilesPic/mdesign.jpg" alt="image" class="img-xs rounded-circle ml-3">
