          ...
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="navbar-brand" href="index-2.html">
                    <!--
                    <img class="brand-logo" alt="stack admin logo" src="../app-assets/images/logo/logo(SVG).svg">
                    -->
              ...
              <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="../profilesPic/mdesign.jpg" alt="avatar"><i></i>
                  </div>
                  <span class="user-name">Mdesign</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" href="superAdminProfile"><i class="feather icon-user"></i> Edit Profile</a>
                  <!--
                  ...
                  <a class="dropdown-item" href="login"><i class="feather icon-power"></i> Logout</a>
                </div>
              </li>
